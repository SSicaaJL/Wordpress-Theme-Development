...
function nusscistudentlife_widgets_init() {
	...
	register_sidebar( array ( // ARCHIVE CONTENT (RIGHT)
		'name'			=> esc_html__( 'Archive Content', 'nusscistudentlife' ),
		'id'			=> 'archive-widget-1',
		'description'	=> esc_html__( 'Sidebar of the archive content', 'nusscistudentlife' ),
		'before_widget'	=> '<div>',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h5>',
		'after_title'	=> '</h5>',
